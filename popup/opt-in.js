...
window.addEventListener("load", function() {
    ...
    browser.storage.local.get("T")                                  // were there old cache entries? If yes, this is an upgrade.
    .then(function(result) { document.getElementById("upgrade-info").hidden = !("T" in result); });   // upgrade if T present
